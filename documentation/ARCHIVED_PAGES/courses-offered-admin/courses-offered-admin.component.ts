...
@Component({
  selector: 'app-courses-offered-admin',
  templateUrl: './courses-offered-admin.component.html',
  styleUrls: ['./courses-offered-admin.component.css']
})
export class CoursesOfferedAdminComponent implements OnInit {
